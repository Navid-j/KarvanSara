...
public class Crew_Move : MonoBehaviour
{
    public int crewTasks;
    
    private Vector3 pointA = Vector3.left; 
    private Vector3 pointB = Vector3.up;
    private Vector3 pointC = Vector3.right;
    ...
    void Start()
    {
        Debug.Log("Tasks in move =  " + crewTasks);
    ...
    {
        Debug.Log("Tasks in move =  " + crewTasks);
        crewTasks = PlayerPrefs.GetInt("CrewTasks");
